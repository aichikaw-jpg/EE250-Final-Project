...
5) Now in the influxdbtest2.py, change the INFLUX_HOST to be your laptop ip. In the influx_client, change the username and password to be your influxdb username and password. You can leave it out, if you don't have it. Change the MQTT_BROKER to have your raspberry pi ip.
